...
monthly_expenses = float(input("Enter your total monthly expenses: "))  # Input for total monthly expenses

# Calculate monthly savings
monthly_savings = (monthly_income-monthly_expenses)  # Calculation for monthly savings
